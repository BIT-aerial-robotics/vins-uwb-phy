...
public:
    mapOptimization()
    {
        ...
        subLaserCloudInfo     = nh.subscribe<lins::cloud_info>     (PROJECT_NAME + "/lidar/feature/cloud_info", 5, &mapOptimization::laserCloudInfoHandler, this, ros::TransportHints().tcpNoDelay());
    ...
    void laserCloudInfoHandler(const lins::cloud_infoConstPtr& msgIn)
    {
        ...
        //建图频率不超过1/mappingProcessInterval
