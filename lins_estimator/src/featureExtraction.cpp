...
public:
    ...
    FeatureExtraction()
    {
        subLaserCloudInfo = nh.subscribe<lins::cloud_info>(PROJECT_NAME + "/lidar/deskew/cloud_info", 5, &FeatureExtraction::laserCloudInfoHandler, this, ros::TransportHints().tcpNoDelay());

        pubLaserCloudInfo = nh.advertise<lins::cloud_info> (PROJECT_NAME + "/lidar/feature/cloud_info", 5);
    ...
    void laserCloudInfoHandler(const lins::cloud_infoConstPtr& msgIn)
    {
